...
function submit() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            changeValueInt(number_1, 14025);
            changeValueInt(number_2, 35);
            changeValueInt(number_3, 7);
            changeValueFloat(number_4, 0.138);
            changeValueFloat(number_5, 0.301);
            changeValueFloat(number_6, 0.014);
            
            Plotly.newPlot('figure_1_1', response['data']['data_1_1'])
            Plotly.newPlot('figure_1_2', response['data']['data_1_2'])
        }
    });
}